...
var TwitchFetcher = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(TwitchFetcher, [{
    ...
    key: "getEmotesByName",
    value: function () {
      var _getEmotesByName = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(username, settings) {
        var data;
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                return _context2.abrupt("return", this.getEmotesByID(data.id, settings));
      ...
      function getEmotesByName(_x2, _x3) {
